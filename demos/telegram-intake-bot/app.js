...
function quickDemo(urgent){
  ...
  toast(urgent?'Демо-статус: срочная, SLA 30 минут':'Демо-статус: назначен ответственный');
}
...
$('takeWork').onclick=()=>{$('leadStatus').className='lead-status active';$('leadStatus').textContent='В работе';toast('Локальный статус изменён на «В работе»');};
